...
export default function App() {
  ...
  const handleCaptureLead = (leadData: Omit<Lead, 'id' | 'createdAt'>) => {
    ...
    .finally(() => {
      ...
      // Dispara o evento de conversão para o Meta Ads
      if (typeof (window as any).fbq === 'function') {
        (window as any).fbq('track', 'Lead');
      }
      
      // Abre o link para baixar a planilha automaticamente
  ...
  return (
    <div className="min-h-screen bg-[#fafbfe] text-slate-950 font-sans selection:bg-indigo-600 selection:text-white antialiased">
      ...
      {/* 1. BARRA DE URGÊNCIA (Topo, fundo escuro) — troquei o número fictício por uma dor real */}
      <div className="bg-slate-950 text-white py-3 px-4 text-center text-xs md:text-sm font-semibold tracking-wide border-b border-slate-900 select-none">
        <span className="inline-flex items-center gap-1.5">
          🧵 Chega de descobrir atraso da facção só quando o cliente já está cobrando — resolva isso hoje, de graça
        </span>
      </div>
          ...
          <section className="relative overflow-hidden pt-12 md:pt-16 pb-20 bg-gradient-to-b from-indigo-950 via-slate-900 to-slate-950 text-white">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div id="lead-form-container" className="lg:col-span-5">
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="text-xs text-slate-400 mt-1">
                            O seu acesso gratuito está totalmente liberado e o download já começou!
                          </p>
                        </div>
                        
                        {/* Caixa explicativa de Download Concluído */}
                        <div className="bg-emerald-950/40 rounded-xl p-4.5 border border-emerald-500/30 text-left relative overflow-hidden animate-pulse">
                          <div className="absolute top-0 right-0 p-1 bg-emerald-500 text-white rounded-bl-lg text-[9px] font-bold select-none">
                            ATIVO
                          </div>
                          <span className="text-[10px] font-bold text-emerald-400 uppercase tracking-widest block mb-1">Download Concluído!</span>
                          <div className="flex flex-col gap-1 text-xs text-emerald-300">
                            <div className="flex items-center gap-2 font-bold text-emerald-100">
                              ...
                              Seu arquivo (.xlsx) foi baixado!
                            </div>
                            <p className="text-[11px] text-slate-300 font-normal leading-relaxed mt-1.5">
                              Verifique a pasta de <strong>Downloads</strong> do seu dispositivo. Caso o arquivo não tenha sido baixado sozinho, utilize o botão verde abaixo para baixar manualmente.
                            </p>
                          </div>
                        </div>
